 ...
 */
public class SeetingActivity extends Fragment {
    ...
    public static SeetingActivity newInstance(String param1, String param2) {
        SeetingActivity fragment = new SeetingActivity();
